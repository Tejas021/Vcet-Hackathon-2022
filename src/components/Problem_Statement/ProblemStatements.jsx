    ...
    <>
      <div
        ...
        className={classnames(
          styles.mainProblemStatementsContainer,
          styles.grid
        )}
      >
        <br />
      ...
      <div
        ...
        id="Cyber_PS1"
        tabindex="-1"
        aria-labelledby="Cyber_PS1"
        aria-hidden="true"
      >
        <div class="modal-dialog ">
          <div
            class="modal-content "
            style={{ color: "#7A2BAA", background: "#180828" }}
          >
            <div className="modal-header d-flex justify-content-end">
              {/* <h5 class="modal-title " id="Cyber_PS1">Call Tracking for  VoIP</h5> */}
              <button
                type="button"
                className={`${styles.bgBlue} btn text-light d-flex justify-content-center align-items-center `}
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_Cyber_PS1.jpg"
                alt=""
                srcset=""
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_Cyber_PS2.jpg"
                alt=""
                srcset=""
                style={{ width: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_Cyber_PS3.jpg"
                alt=""
                srcset=""
                style={{ width: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_AIMLPS1.jpg"
                alt=""
                srcset=""
                style={{ width: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_AIMLPS2.jpg"
                alt=""
                srcset=""
                style={{ width: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_AIMLPS3.jpg"
                alt=""
                srcset=""
                style={{ width: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_WEB_PS1.jpg"
                alt=""
                srcset=""
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_WEB_PS2.jpg"
                alt=""
                srcset=""
                style={{ maxWidth: "100%", aspectRatio: "1/1" }}
              />
      ...
      >
        <div class="modal-dialog ">
          ...
          >
            <div className="modal-header d-flex justify-content-end">
              {/* <h5 class="modal-title " id="Cyber_PS3">
                Call Tracking for VoIP
              </h5> */}
              <button
                type="button"
                className={`${styles.bgBlue} btn text-light d-flex justify-content-center align-items-center `}
            ...
            <div class="modal-body">
              <img
                src="/problem_statements/CardFlip_WEB_PS3.jpg"
                alt=""
                srcset=""
                style={{ maxWidth: "100%", aspectRatio: "1/1" }}
              />
