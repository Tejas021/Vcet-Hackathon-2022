...
function About() {
    ...
    return (
        <div className='h-100 mb-5' class={`${styles.info}`}>
                            ...
                            <g id="galaxy-outer_circle" transform="translate(-324.5,-325)">
                                ...
                                <g id="galaxy-c7_tr" transform="translate(120,128) rotate(0)">
                                    <g id="galaxy-c7" transform="translate(-120,-128)">
                                        <circle id="galaxy-ellipse-7" r="39" transform="translate(120 128)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                        <g id="galaxy-vuejs">
                                ...
                                <g id="galaxy-c8_tr" transform="translate(42.114967,325) rotate(0)">
                                    <g id="galaxy-c8" transform="translate(-42.114967,-325)">
                                        <circle id="galaxy-ellipse-4" r="39" transform="translate(42 325)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                        <g id="galaxy-nuxtjs">
                                ...
                                <g id="galaxy-c6_tr" transform="translate(325,40) rotate(0)">
                                    <g id="galaxy-c6" transform="translate(-325,-40)">
                                        <circle id="galaxy-ellipse-2" r="39" transform="translate(325 40)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                        <g id="galaxy-docker">
                                ...
                                <g id="galaxy-c1_tr" transform="translate(120,522) rotate(0)">
                                    <g id="galaxy-c1" transform="translate(-120,-522)">
                                        <circle id="galaxy-ellipse-9" r="39" transform="translate(120 522)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                ...
                                <g id="galaxy-c2_tr" transform="translate(325,610) rotate(0)">
                                    <g id="galaxy-c2" transform="translate(-325,-610)">
                                        <circle id="galaxy-ellipse-5" r="39" transform="translate(325 610)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                        <g id="galaxy-group_3">
                                ...
                                <g id="galaxy-c3_tr" transform="translate(541.996582,514.5) rotate(0)">
                                    <g id="galaxy-c3" transform="translate(-541.996582,-514.5)">
                                        <circle id="galaxy-ellipse-6" r="38.5" transform="translate(536.5 514.5)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                ...
                                <g id="galaxy-c4_tr" transform="translate(610,325) rotate(0)">
                                    <g id="galaxy-c4" transform="translate(-610,-325)">
                                        <circle id="galaxy-ellipse-3" r="39" transform="translate(610 325)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
                                        <g id="galaxy-html">
                                ...
                                <g id="galaxy-c5_tr" transform="translate(537,140) rotate(0)">
                                    <g id="galaxy-c5" transform="translate(-537,-140)">
                                        <circle id="galaxy-ellipse-8" r="39" transform="translate(537 140)" fill="#27282d" stroke="#dc3545" stroke-width="2" />
