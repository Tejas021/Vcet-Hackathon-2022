  ...
  return (
    <div className='container p-md-5 p-3 py-4 my-5' id="Guidelines">
      ...
      <ul className={`text-light ${styles.ruleList}`}>
        ...
        <li> Payment for the selected teams i.e. Rs.500 per team should be made by <span className={`${styles.hLight}`}>October 02, 2022</span>. Entry fee payment of the entire team should be done in a single transaction.</li>
